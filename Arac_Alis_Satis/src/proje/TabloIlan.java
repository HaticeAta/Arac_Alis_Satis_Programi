 ...
 * @author Hatice
 */
public class TabloIlan extends AbstractTableModel {
    ...
    public TabloIlan(ResultSet res) throws SQLException {
        this.res = res;
    ...
    String[] isim = {"IlanID", "IlanAdi", "IlanFiyat", "IlanKm", "IlanTarih", "SehirID", "ArabaID"};
