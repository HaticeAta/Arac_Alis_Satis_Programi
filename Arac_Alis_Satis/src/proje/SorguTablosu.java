 ...
 * @author Hatice
 */
public class SorguTablosu extends AbstractTableModel {
    ...
    public SorguTablosu(ResultSet res) throws SQLException {
        this.res = res;
    ...
    String[] isim = {"İlanAdi", "Fiyat", "KM", "Tarih", "Sehir", "Marka", "Model", "Vites", "Yakit", "Renk"};
